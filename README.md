...
**Coverage: all 34 districts on the source page, 213 constituencies, 54,876
...
Drop `--district` to do the whole state: **34 districts, 213 constituencies,
54,876 booth PDFs**, roughly 15 hours at ~60 booths/min — or ~1 hour on Actions,
